  ...
  template: `<div>
              ...
              <div class="container">
                ...
                <div class="d-flex justify-content-center position-relative">
                  <div style="margin-top: 25px; background-color: black; width: 97%; height: 2px; position: absolute;"></div>
                  <span class="h1" style="background-color: white; padding-left: 5px; padding-right: 5px; z-index: 2;">Affiliations</span>
                </div>
